...
},{"./Cargando":3,"jquery":6}],2:[function(require,module,exports){
'use strict';
...
var errorGafa = function errorGafa(texto, clase) {
  clearTimeout(timer);
  (0, _jquery2.default)(elementoErrorGF).remove();
  switch (clase) {
    case 'inicio':
      if ((0, _jquery2.default)(elementoErrorGF).length == 0) {
...
alert = errorGafa;
var timer;
var funcionElementoError = function funcionElementoError() {
  if ((0, _jquery2.default)(elementoErrorGF).length != 0) {
    (0, _jquery2.default)(elementoErrorGF).animate({ top: 0 }, 500);
    (0, _jquery2.default)(elementoErrorGF).attr('title', 'Elimina este mensaje');
    timer = setTimeout(function () {
      if ((0, _jquery2.default)(elementoErrorGF).length != 0) {
        (0, _jquery2.default)(elementoErrorGF).fadeOut('fast', function () {
          (0, _jquery2.default)(elementoErrorGF).remove();
        });
      }
    }, 8000);
...
(0, _jquery2.default)(document).ready(function () {
  body.on('click', elementoErrorGF, function () {
    (0, _jquery2.default)(elementoErrorGF).fadeOut('slow', function () {
      (0, _jquery2.default)(elementoErrorGF).remove();
      clearTimeout(timer);
    });
  });
...
var IniciarWeb = {
    ...
    configurar_Web: function configurar_Web() {},
    link_actual: function link_actual() {
        var url = document.location.href;
        (0, _jquery2.default)('[href="' + url + '"]').addClass('link_actual');
    }
};
...
var _IniciarWeb = require('./helpers/IniciarWeb');

var _IniciarWeb2 = _interopRequireDefault(_IniciarWeb);

var _AjaxHelpers = require('./helpers/AjaxHelpers');
 ...
 * Seteo de globales
 **/
window.AjaxHelpers = _AjaxHelpers2.default;

},{"./helpers/AjaxHelpers":1,"./helpers/Alerta":2,"./helpers/IniciarWeb":4}],6:[function(require,module,exports){
